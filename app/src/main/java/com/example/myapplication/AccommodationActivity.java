...
public class AccommodationActivity extends AppCompatActivity
{
    ...
    FirebaseRecyclerAdapter<Model, ViewHolderhotels> firebaseRecyclerAdapter;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReference=mFirebaseDatabase.getReference("Accommodations");
    ...
    {
        Query firebaseSearchQuery=mReference.orderByChild("search").startAt(searchText).endAt(searchText + "\uf8ff");
        ...
        firebaseRecyclerAdapter=
                new FirebaseRecyclerAdapter<Model, ViewHolderhotels>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull ViewHolderhotels holder, int position, @NonNull Model model) {

                        holder.sethotels(context,model.getTitle(),model.getImage(),model.getDescription(),model.getLocation(),model.getUrl());
                    }

                    @NonNull
                    @Override
                    public ViewHolderhotels onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
